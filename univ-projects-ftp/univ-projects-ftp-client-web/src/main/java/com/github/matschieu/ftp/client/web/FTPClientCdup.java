 ...
 * @author Matschieu
 */
public class FTPClientCdup extends HttpServlet {

	/**
	 * Executes a CDUP commande before to redirect to LIST
	 * @param req
	 * @param resp
	 */
	public void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		String request = FTPClientInfo.CMD_CDUP;
		String response;
		int returnCode;
		// Get the session
		...
		try {
			...
			// Send a CDUP command to the server to close the connection...
