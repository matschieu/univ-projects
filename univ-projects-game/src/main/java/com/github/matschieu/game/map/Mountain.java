 ...
 *@author Matschieu
 */
public class Mountain implements CellType {
	
	/** String description of this type */
	public static final String DESCRIPTION = Localization.SINGLETON.getElement("MOUNTAIN_DESCRIPTION");
	
	/**
	 * Constructs a new mountain type 
	 */	
	public Mountain() { }
	...
	public String getSymbole() {
		return Localization.SINGLETON.getElement("MOUNTAIN_SYMBOLE");
	}
